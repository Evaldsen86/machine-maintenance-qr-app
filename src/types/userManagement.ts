...
export type FormUserRole = 'admin' | 'leader' | 'lagermand' | 'mechanic' | 'technician' | 'driver' | 'blacksmith' | 'viewer' | 'customer' | 'guest';
...
export const userFormSchema = z.object({
  ...
  role: z.enum(["viewer", "driver", "mechanic", "technician", "blacksmith", "leader", "lagermand", "admin", "customer", "guest"] as const),
