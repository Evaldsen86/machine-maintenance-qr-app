...
export const mockTasks: Task[] = [
  ...
  {
    id: 'task-4',
    title: 'Kontrol af olie og filtre',
    description: 'Kontroller motorolie og udskift oliefilter',
    dueDate: '2023-10-20',
    status: 'pending',
    priority: 'low',
    assignedTo: '4',
  ...
  {
    id: 'task-5',
    title: 'Eftersyn af lygter',
    description: 'Kontroller alle lygter og blinklys',
    dueDate: '2023-10-25',
    status: 'pending',
    priority: 'medium',
    assignedTo: '5',
...
export const mockMachines: Machine[] = [
  ...
  },
  {
    ...
    tasks: [
      ...
      {
        id: 'task-7',
        title: 'Kontrol af kranens kabler',
        description: 'Inspektion af løftekabler og sikkerhedssystemer',
        dueDate: '2023-10-30',
        status: 'pending',
        priority: 'critical',
        assignedTo: '4',
      ...
      {
        id: 'task-8',
        title: 'Vedligeholdelse af spil',
        description: 'Lubrikation og kontrol af spilfunktioner',
        dueDate: '2023-11-05',
        status: 'in-progress',
        priority: 'medium',
        assignedTo: '5',
    ...
    tasks: [
      {
        id: 'task-9',
        title: 'Årlig service',
        description: 'Komplet årlig service af motor og gearkasse',
        dueDate: '2023-12-01',
        status: 'pending',
        priority: 'high',
        assignedTo: '2',
      ...
      {
        id: 'task-10',
        title: 'Kontrol af spilkabler',
        description: 'Inspektion og vedligeholdelse af spilkabler',
        dueDate: '2023-11-20',
        status: 'pending',
        priority: 'medium',
        assignedTo: '4',
